    ...
    <table class="table table-striped table-hover">
        ...
        ?>
            <tr>
				...
				<td>					 
				<a href="ubah_obat.php?id=<?= $data['id_obat'];?>" role="button"><i class="fa-solid fa-pen-to-square"></i>Ubah</a>
				<a href="hapus_obat.php?id=<?= $data['id_obat'];?>" role="button" onclick="return confirm('Apakah yakin akan menghapus data?');"> <i class="fa-solid fa-trash-can"></i> Hapus</a>				
				</td>
            </tr>
        <?php } ?>
    </table>
